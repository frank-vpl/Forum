<x-layouts::auth>
    <div class="flex flex-col gap-6">
        ...
        <a href="{{ url('/redirect/x').(request('redirect') ? ('?redirect='.urlencode(request('redirect'))) : '') }}" class="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-zinc-300 dark:border-zinc-700 px-4 py-2 text-sm text-zinc-900 dark:text-white hover:bg-zinc-50 dark:hover:bg-zinc-800">
