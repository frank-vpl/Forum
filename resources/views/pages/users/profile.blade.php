    ...
    <div class="mb-8">
        ...
        <div class="hidden md:flex flex-col items-center text-center gap-3">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-600 dark:text-gray-300">
                <span><span class="font-semibold text-gray-900 dark:text-white">{{ $commentsTotal }}</span> Comments</span>
                <span><span class="font-semibold text-gray-900 dark:text-white">{{ $viewsTotal }}</span> Views</span>
                <span><span class="font-semibold text-gray-900 dark:text-white">{{ $postsCount }}</span> Posts</span>
            </div>
